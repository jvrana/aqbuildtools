from aqbt.aquarium.dasi import DesignFactory
from lobio.klavinslab.dasi.dfs import KlavinsLabDnaDb
import pytest
...
def test_dasi_design_debug_mode_init(cached_span_cost):
...
def test_dasi_design_production_init(cached_span_cost):
    registry = sessions.klregistry
...
def test_fake_design(random_chunk_prob_int, n_builds, cached_span_cost):
    registry = sessions.klregistry
...
def test_design(cached_span_cost):
    registry = sessions.klregistry
